      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex items-center space-x-4">
            ...
            <!--LinkedIn-->
            <a href="https://www.linkedin.com/company/nline/posts/?feedView=all" target="_blank" class="text-gray-600 hover:text-gray-900">
            ...
            <!--Twitter/X-->
            <a href="https://x.com/nLineInc" target="_blank" class="text-gray-600 hover:text-gray-900">
              <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
